...
using blzr_wasm.Server.Services;
...
namespace blzr_wasm.Server.Controllers
{
    ...
    // C:\Users\SeanGlover\source\repos\blzr_wasm\blzr_wasm\Server\bin\Debug\net6.0\blzr_wasm.Server.xml

    namespace blzr_wasm.Controllers
    {
